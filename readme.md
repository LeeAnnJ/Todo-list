...
3. 准备`vuex`，存储登录后与账号信息有关的全局变量
4. 界面要继续扣细节：别扭的样式要调&提升使用体验的响应时间
5. 文档可以写一写了
...
**本周前端任务完成情况：**
1. ~~登录界面~~和注册界面设计，这个要看后端的账号数据怎么设计了，在连后端之前没啥难度，所以尽量好看一些
...
6. 任务项细化：实现图标功能响应事件，包括但不限于~~设置星标~~、截止时间和周期性、~~待办变完成~~、点击查看任务详情、删除任务
