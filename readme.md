...
[外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-pDKUBkKh-1673685336763)(/UIdesign/体系结构总图.png)]]
...
[外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-tFUDqmil-1673685336766)(/UIdesign/任务模块结构图.png)]]

#### 3 1.3 用户模块结构图

[外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-bwjDAGa2-1673685336769)(/UIdesign/用户模块结构图.png)]]
...
### 3.5 交互界面设计
初步设定主界面设计如下：
[外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-yCQfgOL1-1673685336770)(/UIdesign/mainWindow.png)]]
