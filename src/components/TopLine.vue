  ...
  <div class="header">
    ...
    <div class="bell_block">
      <el-popover placement="bottom" :width="300" trigger="click">
        <template #reference>
          <el-icon class="bell" :size="24" @click="unreadVis=true;allVis=false"><Bell /></el-icon>
        </template>
      ...
      <el-collapse-item title="全部消息" name="2">
        <div>
          <ul v-infinite-scroll="load" class="infinite-list" style="overflow: auto">
            <li v-for="info in infomation" class="infinite-list-item">{{info.date}}{{info.data}}&nbsp;{{info.content}}
    ...
    <div class="edit_info_block">
        ...
        >
        <div>
          <span class="edit_words1">用户名：</span><el-input class="input_username" v-model="username" placeholder="real_un" />
          <br><br>
          ...
          /></span>
          <span class="edit_words4">简介：</span><el-input class="input_intro" v-model="introduction" placeholder="real_intro" />
          <br><br><br><br><br>
      </div>
      <template #footer>
