...
class Task {
    constructor(task_id, task_creater_id, task_name, task_description, task_type, task_priority, task_ddl, task_group_id = 0, belongs_folder_id = 0, isfavor = false, status = 0, cycle = 0) {
